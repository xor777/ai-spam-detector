...
spam_handler = logging.FileHandler('spam_log.txt')
...
def is_spam(message, context):
    ...
    5. Use of emojis to attract attention and give a positive image to the message (e.g., 🤝💼😉).
    ...
    10. Out of context of the ongoing conversation in the chat.
